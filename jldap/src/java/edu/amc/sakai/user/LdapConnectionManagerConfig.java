...
public interface LdapConnectionManagerConfig {
	...
	/**
	 * @return The maximum number of details to lookup in one query.
	 * @deprecated {@link #getBatchSize()}
	 */
	public int getMaxObjectsToQueryFor();
	
	/**
	 * @param maxObjectsToQueryFor The maximum number deatils to lookup in one query.
	...
	/**
	 * @param batchSize The maximum number deatils to lookup in one query.
	 */
